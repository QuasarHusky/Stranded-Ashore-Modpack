...
// ===== Capacitors ===== //
recipes.addShapedMirrored("immersiveengineering/capacitor/lv", <immersiveengineering:metal_device0:0>, [
    [<immersiveengineering:connector:0>, <ore:wireCopper>, <immersiveengineering:connector:0>],
    [<ore:scaffoldingTreatedWood>, <ore:plateLead>, <ore:scaffoldingTreatedWood>],
    [<ore:scaffoldingTreatedWood>, <ore:plateCopper>, <ore:scaffoldingTreatedWood>]
]);

recipes.addShapedMirrored("immersiveengineering/capacitor/mv", <immersiveengineering:metal_device0:1>, [
    [<immersiveengineering:connector:2>, <ore:wireElectrum>, <immersiveengineering:connector:2>],
    [<ore:scaffoldingAluminum>, <ore:plateNickel>, <ore:scaffoldingAluminum>],
    [<ore:scaffoldingAluminum>, <ore:plateInvar>, <ore:scaffoldingAluminum>]
]);

recipes.addShapedMirrored("immersiveengineering/capacitor/hv", <immersiveengineering:metal_device0:2>, [
    [<immersiveengineering:connector:4>, <immersiveengineering:wirecoil:2>, <immersiveengineering:connector:4>],
    [<ore:concrete>, <liquid:creosote> * 1000, <ore:concrete>],
    [<ore:blockSheetmetalSteel>, metals.lead.double_sheet, <ore:blockSheetmetalSteel>]
]);
