...
MetalPress.removeRecipeByMold(<immersiveengineering:mold:3>);
MetalPress.removeRecipeByMold(<immersiveengineering:mold:4>);
MetalPress.removeRecipeByMold(<immersiveengineering:mold:5>);
MetalPress.removeRecipeByMold(<immersiveengineering:mold:6>);
