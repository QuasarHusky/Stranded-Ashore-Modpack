...
recipes.addShapeless("return_scroll", <waystones:return_scroll>.withAmount(2), [
    <ore:enderpearl>,
    <ore:paper>,
    <ore:gemChipped>
]);

recipes.addShapeless("bound_scroll", <waystones:bound_scroll>.withAmount(2), [
    <ore:enderpearl>,
    <ore:paper>,
    <ore:gemFlawed>
]);

recipes.addShapeless("warp_scroll", <waystones:warp_scroll>.withAmount(2), [
    <ore:enderpearl>,
    <ore:paper>,
    <ore:gemNormal>
]);
